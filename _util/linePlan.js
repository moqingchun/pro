        ...
        init:function () {
            ...
            AMap.event.addListener(autocomplete, "select", function(e){
                ...
                placeSearch.search(e.poi.name,function (a,b) {
                    if(a==='complete'){
                        // console.log(b)
                        that.posi = [b.poiList.pois[0].location.lng,b.poiList.pois[0].location.lat]
                        ...
                        if(that.dragPoints.length){
                            if(!that.marker1){
                                if(!!that.marker2){
                                    ...
                                    var points = copy1.concat(copy2);
                                    points.shift()
                                    that.dragPoints = points
            ...
            if(that.originLngLat.length&&that.endLngLat.length){
                ...
                that.driving.on('complete',function (res) {
                    ...
                    that.dragPoints = res.data.waypoints.map(function (v) {
                        return [v.location.lng,v.location.lat]
                    })
            ...
            function parseRouteToPath(route) {
                ...
                route.steps.map(function (v) {
                    ...
                    arr.push({
                        ...
                        area:[v.start_location.lng,v.start_location.lat]
                    })
